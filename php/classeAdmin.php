						...
						<?php  
							...
							if ($query2 && $query2->num_rows > 0) {
								while ($foto = $query2->fetch_object()) {
									echo "<div class='col- col-xs-6 col-md3- col-lg-2'> <img src='fotos/postagens/".$foto->img."' class='col-'><button class='btn col-' onclick='excluirFoto(`".$foto->id."`);'>excluir</button><small id='respExcluir".$foto->id."' style='padding: 5px;'></small></div><div style='min-width:20px;'></div>";
								}
							}
						?>
					</div>
